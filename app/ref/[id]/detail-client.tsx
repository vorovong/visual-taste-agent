      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-neutral-950/70 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between gap-2 px-4 sm:px-6 lg:px-8">
          ...
          <a
            ...
            className="flex items-center gap-1.5 shrink-0 rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 text-xs font-medium text-neutral-400 transition-all hover:bg-white/[0.06] hover:text-neutral-200 hover:border-white/[0.12]"
          >
